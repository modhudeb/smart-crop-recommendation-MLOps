...
class CalibratedCatBoost(BaseEstimator, ClassifierMixin):
    ...
    def __init__(self, iterations=500, depth=6, learning_rate=0.05,
                 val_fraction=0.2, meta_model=None, meta_weight=0.25,
                 verbose=0, random_state=42, cat_features=None):
    ...
    def fit(self, X, y):
        ...
        sss = StratifiedShuffleSplit(n_splits=1, test_size=self.val_fraction,
        ...
        self.model_ = CatBoostClassifier(
            ...
            eval_metric="Accuracy", random_seed=self.random_state,
            verbose=self.verbose >= 2, task_type="CPU", thread_count=-1,
        )
...
def build_catboost(random_state=42):
    return CatBoostClassifier(
        iterations=200, learning_rate=0.04, depth=None,
...
def build_calibrated_catboost_svc(random_state=42):
    ...
    return CalibratedCatBoost(
        iterations=200, depth=None, learning_rate=0.04,
        val_fraction=0.3, meta_model=meta,
        meta_weight=0.2, verbose=0, random_state=random_state,
    )
...
def build_voting_classifier(random_state=42, rf_params=None):
    ...
    estimators = [
        ...
        ('cat', CatBoostClassifier(
            ...
            loss_function='MultiClass', verbose=0, random_seed=random_state,
        )),
    ]

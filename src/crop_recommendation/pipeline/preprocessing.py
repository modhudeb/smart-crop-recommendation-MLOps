...
class Preprocessing:
    ...
    def __init__(self, df: pd.DataFrame, save_path: str = "./data/processed/processed_data.csv", log_dir: str = "reports/logs"):
        """
...
if __name__ == "__main__":
    try:
        ...
        preprocessor = Preprocessing(df=df_raw, save_path=processed_data_path, log_dir="./reports/logs")

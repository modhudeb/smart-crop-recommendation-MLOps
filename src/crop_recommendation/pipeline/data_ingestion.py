...
class DataIngestion:
    def __init__(self, data_path: str, log_dir: str = "reports/logs"):
...
if __name__ == "__main__":
    ...
    data_path = "./data/external/SPAS-Dataset-BD.csv"
    save_path = "./data/raw/SPAS-Dataset-BD.csv"

    ingestion = DataIngestion(data_path=data_path, log_dir="./reports/logs")
